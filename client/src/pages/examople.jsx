...
const Home = () => {
  return (
    <div className='font-sans text-slate-900'>
      {/* 1. Hero Section */}
      <section className="relative h-[650px] flex flex-col font-sans overflow-hidden">
  {/* --- 1. Background Image (Exactly as per Screenshot) --- */}
  <div className="absolute inset-0 z-0">
    <img
      src="/images/background/Home Page Update/Images/Industrial Machine Sales & Services.png"
      alt="Industrial Machines"
      className="w-full h-full object-cover object-[center_20%] lg:object-[center_30%]" 
      /* Object-position mule machines barobar frame madhe yetat */
    />
    {/* Subtle dark overlay to match the original look */}
    <div className="absolute inset-0 bg-black/35"></div>
  </div>

  {/* --- 2. Main Content (Positioned exactly like screenshot) --- */}
  <div className="relative z-10 flex-grow flex items-start max-w-7xl mx-auto px-6 lg:px-16 w-full pt-20">
    <div className="max-w-2xl text-left">
      <h1 className="text-white text-5xl lg:text-6xl font-bold leading-tight drop-shadow-md">
      ...
      <div className="mt-6 flex flex-col gap-2">
        ...
        <p className="text-xl text-white font-medium">
          Lathe | Milling | Drilling | Power Press | Workshop Machines
        </p>
      </div>

      <div className="mt-10 flex gap-4">
        <button className="bg-[#8b1d31] text-white px-8 py-3 rounded shadow-md font-bold text-lg">
          Get Quote
        </button>
        <button className="bg-[#eeb44b] text-slate-900 px-8 py-3 rounded shadow-md font-bold text-lg">
          View Products
        </button>
      </div>
    </div>
  ...
  {/* --- 3. White Trust Bar (At the bottom of Section) --- */}
  <div className="relative z-20 w-full bg-white py-6 shadow-[-5px_0_15px_rgba(0,0,0,0.1)]">
    <div className="max-w-7xl mx-auto px-6">
      <div className="flex flex-col md:flex-row justify-around items-center gap-6">
        
        {/* Experience */}
        <div className="flex items-center gap-4">
          <img src="/images/icons/star-icon.png" className="w-10 h-10 object-contain" alt="Experience" />
          <div className="flex flex-col text-left">
            <span className="text-xl font-bold text-slate-900 leading-none tracking-tight">20+ Years</span>
        ...
        {/* Trusted Supplier */}
        <div className="flex items-center gap-4">
          <img src="/images/icons/shield-icon.png" className="w-10 h-10 object-contain" alt="Supplier" />
          <div className="flex flex-col text-left">
            <span className="text-xl font-bold text-slate-900 leading-none tracking-tight">Trusted Machine</span>
            <span className="text-[10px] font-black text-red-600 uppercase tracking-widest">Supplier</span>
          </div>
        </div>
        ...
        {/* Delivery */}
        <div className="flex items-center gap-4">
          <img src="/images/icons/truck-icon.png" className="w-10 h-10 object-contain" alt="Delivery" />
          <div className="flex flex-col text-left">
            <span className="text-xl font-bold text-slate-900 leading-none tracking-tight">Fast Delivery</span>
            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Across India</span>
          </div>
        </div>
      ...
      {/* 3. Our Industrial Machines Section */}
      <section className='py-20 px-6 bg-slate-50'>
        <div className='max-w-7xl mx-auto text-center'>
          <h2 className='text-3xl font-bold mb-12'>Our Industrial Machines</h2>
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
            {[
              ...
              >
                ...
                />
                <h4 className='font-bold text-lg'>{machine}</h4>
                <p className='text-sm text-slate-500 mb-4'>
                  High precision and durable lathe for precise metalworking
                  tasks.
                </p>
                <button className='w-full bg-slate-800 text-white py-2 rounded hover:bg-slate-900'>
                  View Details
                </button>
              </div>
            ))}
      ...
      {/* 4. i-NAX Promo Section */}
      <section className='bg-slate-900 text-white py-16 px-6'>
        <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12'>
          <div className='md:w-1/2'>
            <h2 className='text-3xl font-bold mb-4'>
              Introducing i-NAX – <br />
              CNC & Laser Machine Solutions
            </h2>
            <p className='text-slate-300 mb-6 italic font-light'>
              i-NAX is our newly launched brand specializing in advanced CNC and
              Laser Cutting Machines designed for precision, speed, and modern
              manufacturing needs.
            </p>
      ...
      <section className='py-20 px-6'>
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8 text-center mb-16'>
            <div>
              <Settings className='mx-auto text-blue-600 mb-2' />
              <h4 className='font-bold'>Trusted Supplier</h4>
              <p className='text-xs text-slate-500'>
                Reliable products with guaranteed quality.
              </p>
            </div>
            <div>
              <Hammer className='mx-auto text-blue-600 mb-2' />
              <h4 className='font-bold'>Experienced Team</h4>
              <p className='text-xs text-slate-500'>
                Expert technical support at every step.
              </p>
            </div>
            <div>
              <Wrench className='mx-auto text-blue-600 mb-2' />
              <h4 className='font-bold'>Reliable Machines</h4>
              <p className='text-xs text-slate-500'>
                Tested and certified industrial equipment.
              </p>
            </div>
            <div>
              ...
              <p className='text-xs text-slate-500'>
                On-time delivery across all locations.
              </p>
            </div>
          </div>
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-20'>
            {[
              ...
              <div
                key={i}
                className='bg-slate-100 p-6 rounded text-center font-bold text-slate-700 border hover:border-blue-400 transition cursor-default'
              >
                {industry}
              </div>
            ))}
      ...
      <section className='bg-slate-50 py-16 px-6'>
        <div className='max-w-3xl mx-auto text-center'>
          ...
          <div className='bg-white p-8 rounded-lg shadow-sm italic text-lg text-slate-700 relative'>
            <span className='text-6xl text-slate-200 absolute top-0 left-4 leading-none'>
              “
            </span>
            "Reliable machine supplier with good service support. Highly
            recommended for heavy machinery needs in Nagpur."
            <div className='mt-4 font-bold text-sm not-italic'>
