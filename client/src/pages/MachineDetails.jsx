...
//       {/* items-stretch मुळे डावा आणि उजवा भाग समान उंचीचे होतात */}
//       <div className="flex flex-col lg:flex-row lg:items-stretch gap-12">
        
//         {/* LEFT: Image Container (आता टेक्स्टच्या उंचीनुसार सेट होईल) */}
//         <div className="flex-1 relative min-h-350 lg:min-h-0">
//           <div className="lg:absolute lg:inset-0 rounded-2xl overflow-hidden shadow-2xl border-b-10 border-red-700">
//             <img 
//               src={machine.image} 
//               alt={machine.name} 
...
//         {/* RIGHT: Content (हा मजकूर इमेजची उंची ठरवेल) */}
...
//             <div>
//               <h3 className="text-sm font-black uppercase mb-3 tracking-wider text-gray-400">Technical Specs</h3>
//               <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
//                 {machine.specs.map((spec, index) => (
//                   <div key={index} className="flex items-center gap-2 bg-gray-50 p-3 rounded border-l-4 border-red-700">
//                     <span className="text-gray-800 font-bold text-[12px] uppercase">{spec}</span>
//                   </div>
//                 ))}
//               </div>
//             </div>
...
//             <button className="flex-1 px-8 py-4 bg-red-700 text-white font-black rounded shadow-lg hover:bg-gray-800 transition-all uppercase text-xs tracking-widest">
//               Inquire Now
//             </button>
//             <button className="flex-1 px-8 py-4 border-2 border-gray-900 text-gray-900 font-black rounded hover:bg-gray-900 hover:text-white transition-all uppercase text-xs tracking-widest">
//               Download PDF
//             </button>
//           </div>
//         </div>
