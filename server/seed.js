...
const inaxSectionData = [
    { name: "Fiber Laser Cutting", dataType: "product", category: "inax", image: "/home/mechindustrialmachine/Lathe Machine.png", shortDescription: "High-speed laser cutting solution." },
...
const seedDB = async () => {
    try {
        ...
        const allMachines = [...millingMachines, ...drillingMachines, ...industrialMachines, ...inaxSectionData, ...customerGallery];
